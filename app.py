...
# export FLASK_SECRET_KEY='A1b2C3d4E5f6G7h8'
...
def chat_predict():
    ...
    arr = pd.DataFrame((np.array([[depend, education, employment, income, loan_amount, loan_term, score, resident, commercial, luxury, bank]])), columns)
